...
def test_main_writes_combined(monkeypatch, tmp_path, capsys):
    # 1) Kleine Umgebung
    ...
    # 6) Prüfen: Variante + Combined geschrieben
    ...
    # Combined sollte >=1 Trade enthalten
    combined_sizes = [cnt for cnt, n, _ in calls if n == "trades_all_variants.csv"]
    assert combined_sizes and combined_sizes[0] >= 1
